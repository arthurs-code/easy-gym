(() => {
  ...
  const I18N = {
      "en": {
            ...
            "directLinkComingSoon": "Plan-Link is available in the App Store version of Easy Gym.",
            ...
            "supportIntro": "Easy Gym is a simple paid app with no ads. You can support the project by sharing the app, leaving a review, or sending feedback.",
            ...
            "aboutHtml": "<div class=\"card about-card\"><h2>Easy Gym — Plan, Go, Log</h2><p>A simple, ad-free training tracker for serious training. Build your PLAN, start your workout in GO, and keep every result in LOG — all on your phone.</p></div><div class=\"card about-card\"><h2>Preface</h2><p>I created Easy Gym for my own training. The App Store version is a simple paid app with no ads. Need help or want your own app? Write to: arthur.stivenson@gmail.com.</p></div><div class=\"card about-card\"><h2>PLAN</h2><p>Create a plan for any date. Use <strong>+ EXERCISE</strong> to add exercises with kg, reps, and sets. Use <strong>DEL</strong> to remove exercises. Save the plan when it is ready.</p></div><div class=\"card about-card\"><h2>GO</h2><p>Start from a saved PLAN. You can adjust kg, reps, and sets during the workout or add another <strong>+ EXERCISE</strong>. Your original PLAN stays unchanged for next time.</p></div><div class=\"card about-card\"><h2>LOG</h2><p>Compare planned targets with actual results. Completed sets are marked green. Save or share your final training log.</p></div><div class=\"card about-card\"><h2>MGMT &amp; share</h2><p><strong>Share Plan as Link</strong> — creates a very compact PLAN-Link. The receiver opens the link in Easy Gym and confirms import.</p><p><strong>Share Plan File or LOG</strong> — When you share a file, we create a secure link you can send via WhatsApp or other messengers.</p><p><strong>Save File or LOG</strong> — saves it locally.</p><p><strong>Insert Plan File</strong> — imports a received plan file into Easy Gym.</p></div><div class=\"card about-card\"><h2>Backup</h2><p>Backup saves a full copy. Restore recovers your data. Delete Data wipes everything after confirmation.</p></div><div class=\"card about-card\"><h2>Privacy</h2><p>Easy Gym works on your phone. Your plans and logs stay on your device unless you share them.</p></div>"
      },
      "de": {
            "langName": "Deutsch",
            "days": {
            ...
            "directLinkComingSoon": "Plan-Link ist in der App-Store-Version von Easy Gym verfügbar.",
            ...
            "supportIntro": "Easy Gym ist eine einfache kostenpflichtige App ohne Werbung. Du kannst das Projekt unterstützen, indem du die App teilst, eine Bewertung hinterlässt oder Feedback sendest.",
            ...
            "aboutHtml": "<div class=\"card about-card\"><h2>Easy Gym — Plan, Go, Log</h2><p>Ein einfacher Trainings-Tracker ohne Werbung für ernsthaftes Training. Erstelle deinen PLAN, starte dein Training mit GO und speichere jedes Ergebnis im LOG — alles auf deinem Telefon.</p></div><div class=\"card about-card\"><h2>Vorwort</h2><p>Ich habe Easy Gym für mein eigenes Training erstellt. Die App-Store-Version ist eine einfache kostenpflichtige App ohne Werbung. Brauchst du Hilfe oder möchtest du deine eigene App? Schreib mir: arthur.stivenson@gmail.com.</p></div><div class=\"card about-card\"><h2>PLAN</h2><p>Erstelle einen Plan für ein beliebiges Datum. Mit <strong>+ ÜBUNG</strong> fügst du Übungen mit kg, Wiederholungen und Sätzen hinzu. Mit <strong>LÖSCHEN</strong> entfernst du Übungen. Speichere den Plan, wenn er bereit ist.</p></div><div class=\"card about-card\"><h2>GO</h2><p>Starte mit einem gespeicherten PLAN. Du kannst kg, Wiederholungen und Sätze während des Trainings anpassen oder eine weitere <strong>+ ÜBUNG</strong> hinzufügen. Dein ursprünglicher PLAN bleibt für das nächste Mal unverändert.</p></div><div class=\"card about-card\"><h2>LOG</h2><p>Vergleiche Planvorgaben direkt mit deinen echten Ergebnissen. Erledigte Sätze werden grün markiert. Speichere oder teile deinen fertigen Trainingslog.</p></div><div class=\"card about-card\"><h2>Verwalten &amp; teilen</h2><p><strong>Plan als Link teilen</strong> — erstellt einen sehr kompakten PLAN-Link. Der Empfänger öffnet den Link in Easy Gym und bestätigt den Import.</p><p><strong>Plan oder Log teilen</strong> — Wenn du eine Datei teilst, erstellen wir einen sicheren Link, den du per WhatsApp oder über andere Messenger senden kannst.</p><p><strong>Plan oder Log speichern</strong> — speichert ihn lokal.</p><p><strong>Plan-Datei einfügen</strong> — importiert eine erhaltene Plan-Datei in Easy Gym.</p></div><div class=\"card about-card\"><h2>Backup</h2><p>Backup speichert eine vollständige Kopie. Restore stellt deine Daten wieder her. Daten löschen löscht alles nach Bestätigung.</p></div><div class=\"card about-card\"><h2>Datenschutz</h2><p>Easy Gym funktioniert auf deinem Telefon. Deine Pläne und Logs bleiben auf deinem Gerät, ausser du teilst sie.</p></div>"
      },
      "fr": {
            "langName": "Français",
            "days": {
            ...
            "supportIntro": "Easy Gym est une app simple et sans publicité. Vous pouvez soutenir le projet en partageant l’app, en laissant un avis ou en envoyant vos commentaires.",
            "confirmInsert": "Insert will override Plans - confirm",
            "confirmRestore": "Restore will replace All Data - confirm",
            "confirmDelete": "Delete will erase All Data - confirm",
            "theme": "Thème",
      ...
      "it": {
            ...
            "supportIntro": "Easy Gym è un’app semplice e senza pubblicità. Puoi sostenere il progetto condividendo l’app, lasciando una recensione o inviando feedback.",
            "confirmInsert": "Insert will override Plans - confirm",
            "confirmRestore": "Restore will replace All Data - confirm",
            "confirmDelete": "Delete will erase All Data - confirm",
            "theme": "Tema",
  ...
  const LEGACY_KEYS = [];
  const DEV_BUILD = 'v179-planlink-p5-small';
