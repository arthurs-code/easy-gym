const CACHE='easy-gym-pwa-v314x-picker-title-go-total-layout-r1';
const ASSETS=[
  ...
  './info/en.html','./info/de.html','./info/fr.html','./info/it.html','./info/es.html','./info/README_INFO_TEXTS.txt','./README_GITHUB_PWA_V314X.txt',
