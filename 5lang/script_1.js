(() => {
  ...
  const LEGACY_KEYS = [];
  const DEV_BUILD = 'v314X-PWA-short-exercise-picker-edit';
  ...
  function showAppStoreShareNotice(){
    return showEasyGymDialog({title:'',hideTitle:true,message:t('appStoreShareNotice'),confirmLabel:t('dialogOk'),tone:'gold',notice:true});
  }
