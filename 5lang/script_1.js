(() => {
  ...
  const LEGACY_KEYS = [];
  const DEV_BUILD = 'v274X-PWA-support-report-layout';
  ...
  function applyLanguageUi(){
    ...
    setMgmtRowText('sharePlanBtn','sharePlan'); setMgmtRowText('sharePlanLinkBtn','sharePlanLink'); setMgmtRowText('manageSavePlanBtn','savePlan'); setMgmtRowText('manageSaveReportBtn','saveReport'); setMgmtRowText('shareReportBtn','shareReport'); setMgmtRowText('printReportBtn','printReport'); setMgmtRowText('insertPlanBtn','insertPlan'); setMgmtRowText('saveAllDataBtn','saveAllData'); setMgmtRowText('restoreAllDataBtn','restoreAllData'); setMgmtRowText('deleteDataBtn','deleteData');
  ...
  function makeReportDocx(){
    ...
    const summaryTable=g=>{
      ...
      const row1=labels.map((v,i)=>reportDocxCell(reportDocxParagraph(reportDocxRun(v,16,'8E8E93',true),{line:180,keep:true,align:i===3?'right':'left'}),widths[i],{top:20,bottom:35,right:i===3?50:120,bottomBorder:'6',bottomBorderColor:'E5E5EA'})).join('');
      const row2=values.map((v,i)=>reportDocxCell(reportDocxParagraph(reportDocxRun(v,28,i===3?'000000':'1C1C1E',true),{line:290,keep:true,align:i===3?'right':'left'}),widths[i],{top:45,bottom:35,right:i===3?50:120})).join('');
