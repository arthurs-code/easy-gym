...
(function (root) {
  ...
  "ui": {
    ...
    "confirmDeleteMessage": "Cette action supprime définitivement de cet appareil tous les plans, entraînements et réglages.",
    "confirmDeleteAction": "Supprimer les données",
    "confirmInsertTitle": "Remplacer les plans existants ?",
    "confirmInsertMessage": "L’importation de ce fichier remplacera les plans actuellement enregistrés dans Easy Gym.",
