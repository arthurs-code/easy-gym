const CACHE='easy-gym-pwa-v209-embedded-activate-row';
const ASSETS=['./','./index.html','./manifest.json','./script_0.js','./script_1.js','./script_2.js','./icons/icon-192.png','./icons/icon-512.png','./icons/maskable-512.png'];
